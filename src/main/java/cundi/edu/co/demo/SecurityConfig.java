...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	//Conexion al application properties
	...
	//Libreria para hashing -incriptar la contraseña
	@Autowired
	private BCryptPasswordEncoder bcrypt;
	
	//Exclusiva en Spring security 
	//login Ayuda a obtener los usuario, roles, las claves de la aplicación
	@Autowired	
	...
	//Como es por servicios toca indicar que es stateless no se manegan estados
