...
public class AuthorizationServer  extends AuthorizationServerConfigurerAdapter{
	...
	//Traemos todo lo configurado al token
	@Autowired
	...
	public void configure(ClientDetailsServiceConfigurer configurer) throws Exception {
		...
		.scopes(scopeRead, scopeWrite).resourceIds(resourceIds).accessTokenValiditySeconds(600)// tiempo de validez del token seg
